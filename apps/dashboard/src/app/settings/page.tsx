    ...
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-6">
        <Card className="p-6 md:p-7">
          <PageHeader
            eyebrow="Pengaturan"
            title="Pengaturan"
            description="Pengaturan aplikasi untuk dashboard NovaNusa."
            actions={<Badge tone="info">{appConfig.environment}</Badge>}
          />
        </Card>

        <Card className="p-5 md:p-6">
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-slate-400">Aplikasi</p>
          <dl className="mt-4 grid gap-3 text-sm leading-6 text-slate-700 md:grid-cols-2">
            <div>
              <dt className="font-medium text-slate-950">Nama</dt>
              <dd className="mt-1">{appConfig.title}</dd>
            </div>
            <div>
              <dt className="font-medium text-slate-950">Deskripsi</dt>
            ...
            <div>
              <dt className="font-medium text-slate-950">URL dasar API</dt>
